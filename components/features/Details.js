		...
		<>
			...
			<div className='my-10 grid grid-cols-1 place-items-center gap-5 px-2 sm:gap-10 lg:grid-cols-2'>
				{features.map((feature) => (
					<div
						className={`text-gray-custom relative flex h-fit min-w-min flex-col rounded-md border border-gray-600 bg-slate-200 shadow-md outline outline-4 outline-transparent transition hover:shadow-lg dark:border-gray-400 dark:bg-slate-700 sm:h-96 sm:w-[30rem] sm:hover:scale-110 xl:w-[36rem]`}
						key={feature.name}
					>
